    ...
    try{
        ...
        for (var i = 0; i < 6; i++) {
            ...
            if (results[i]["poster_path"] !=null && results[i]["poster_path"] !="" && "poster_path" in results[i]) {
                ...
                temp["poster_path"] = `https://image.tmdb.org/t/p/original${url_part}`;
                send_list.push(temp);
            }
        }
            ...
            while( i<20 && len < results.length ){
                ...
                if ("media_type" in results[len] && results[len]["media_type"] == "movie") {
                    ...
                    if (results[len]["backdrop_path"] !=null && results[len]["backdrop_path"] !="" && "backdrop_path" in results[len]) {
                        ...
                        if (results[len]["release_date"] !=null && results[len]["release_date"] !="" && "release_date" in results[len]){
                            
                            temp["year"] = results[len]["release_date"].slice(0,4);
                        }
                        else{
                            temp["year"] = ""
                        }

                        if (results[len]["vote_average"] !=null && results[len]["vote_average"] !="" && "vote_average" in results[len]){
                            
                            temp["rating"] = results[len]["vote_average"];
                        }
                        else{
                            temp["rating"] = "0"
                        }
                        ...
                        temp["backdrop_path"] = `https://image.tmdb.org/t/p/w500${url_part}` || "https://bytes.usc.edu/cs571/s21_JSwasm00/hw/HW6/imgs/movie-placeholder.jpg";
                    ...
                    if (results[len]["backdrop_path"] !=null && results[len]["backdrop_path"] !="" && "backdrop_path" in results[len]) {
                        ...
                        if (results[len]["first_air_date"] !=null && results[len]["first_air_date"] !="" && "first_air_date" in results[len]){
                            
                            temp["year"] = results[len]["first_air_date"].slice(0,4);
                        }
                        else{
                            temp["year"] = ""
                        }
...
//-----------------------------
        ...
        var send_list4 = {};
        send_list4["title"] = results["title"] || "NA";
        send_list4["release_date"] = results["release_date"].slice(0,4)  || "";
        ...
        send_list4["poster_path"] = "https://image.tmdb.org/t/p/original"+results["poster_path"] || "https://cinemaone.net/images/movie_placeholder.png";
        send_list4["backdrop_path"] = "https://image.tmdb.org/t/p/original"+results["backdrop_path"]  || "https://bytes.usc.edu/cs571/s21_JSwasm00/hw/HW6/imgs/movie-placeholder.jpg";
...
//-----------------------------
        ...
        for (var i = 0; i < Math.min(3,results.length); i++) {
            ...
            var temp = {};
            temp["author"] = results[i]["author"] || "Anonymous";
            temp["content"] = results[i]["content"] || "NA";
            temp["created_at"] = results[i]["created_at"].slice(0,10) || "NA";
...
//-----------------------------
        ...
        for (var i = 0; i < Math.min(6,results.length); i++) {
            ...
            if (results[i]["profile_path"] !=null && results[i]["profile_path"] !="" && "profile_path" in results[i]) {
                ...
                temp["poster_path"] = `https://image.tmdb.org/t/p/w500/${url_part}` || "https://bytes.usc.edu/cs571/s21_JSwasm00/hw/HW6/imgs/person-placeholder.png";
...
//-----------------------------
        ...
        for (var i = 0; i < Math.min(10,results.length); i++) {
            ...
            if (results[i]["poster_path"] !=null && results[i]["poster_path"] !="" && "poster_path" in results[i]) {
                ...
                temp["title"] = results[i]["title"];
                temp["poster_path"] = `https://image.tmdb.org/t/p/w500${url_part}`;
                send_list7.push(temp);
            }
        }
        send_json["reco"] = send_list7;
...
//-----------------------------
        ...
        var results = response.data;
        var send_list4 = {};
        send_list4["title"] = results["name"] || "NA";
        send_list4["release_date"] = results["first_air_date"].slice(0,4) || "";
...
//-----------------------------
        ...
        for (var i = 0; i < Math.min(3,results.length); i++) {
            ...
            temp["content"] = results[i]["content"] || "NA";
            temp["created_at"] = results[i]["created_at"].slice(0,10);
            temp["url"] = results[i]["url"];
